...
, mpConfig( config )
{
   ...
   aboutText->setText( tr("<table align='center'><tr><td align='center'>Our hail to the new king:</td></tr>"
   ...
   "<tr><td align='center'>Version 0.6&alpha; written by Sven Oliver Moll.</td></tr>"
   ...
   "<b>[<a href='about:settings'><font color='#ff0000'>Settings</font></a>]</b></td></tr></table>" ) );
