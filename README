...
Tag Editor / DB	Rubberbandman 	alpha	Yello
Downloader	Funkytown 	alpha	Lipps Inc.
Playlist Mgmt 	Karmadrome 	alpha	Pop Will Eat Itself
...
Primary git repository is available at: {git,http}://git.svolli.org/SLART.git
