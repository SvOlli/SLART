/*
 * \file src/tests/TestAppDragAndDrop/MainWidget.cpp
...
void MainWidget::mimeDataByIndex( int index )
{
...
void MainWidget::getMimeData( const QMimeData *remoteMimeData )
{
   int i;
   QByteArray mimeData;
   mpMimeTypes->clear();
...
void MainWidget::handleClipboard()
{
