...
QStringList Database::getGroup( const QString &folder )
{
   QStringList folders;
...
void Database::insertGroup( const QString &folder )
{
...
void Database::deleteGroup( const QString &folder )
{
